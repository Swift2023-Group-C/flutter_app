...
abstract final class FunGridMaps {
  static final Map<String, List<MapTile>> mapTileListMap = {
    ...
    "4": [
      ...
      MapTile(2, 2, MapTileType.otherroom, top: 1, txt: '証明書発行機'),
      ...
      MapTile(2, 2, MapTileType.ev, txt: 'ev', left: 1, top: 1, right: 1),
    ...
    "5": [
      ...
      MapTile(6, 12, MapTileType.otherroom,
    ...
    "R6": [
      ...
      MapTile(3, 4, MapTileType.otherroom, txt: 'R626'),
      ...
      MapTile(4, 2, MapTileType.stair,
          ...
          bottom: 1,
          stairType: const MapStairType(Axis.horizontal, true, false)),
      MapTile(3, 4, MapTileType.otherroom, txt: 'R622'),
